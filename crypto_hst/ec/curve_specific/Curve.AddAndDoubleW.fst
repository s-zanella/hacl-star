...
let double two_p p =
  ...
  let tmp2 = create (Hacl.Cast.uint64_to_sint64 0uL) 5ul in
  let delta = create (Hacl.Cast.uint64_to_sint64 0uL) 5ul in
  let gamma = create (Hacl.Cast.uint64_to_sint64 0uL) 5ul in
  let beta = create (Hacl.Cast.uint64_to_sint64 0uL) 5ul in
  let alpha = create (Hacl.Cast.uint64_to_sint64 0uL) 5ul in
  let ftmp = create (Hacl.Cast.uint64_to_sint64 0uL) 5ul in
  let ftmp2 = create (Hacl.Cast.uint64_to_sint64 0uL) 5ul in
  let small1 = create (Hacl.Cast.uint64_to_sint64 0uL) 5ul in
  let small2 = create (Hacl.Cast.uint64_to_sint64 0uL) 5ul in
...
let add p_plus_q p q =
  let ftmp = create (Hacl.Cast.uint64_to_sint64 0uL) 5ul in 
  let ftmp2 = create (Hacl.Cast.uint64_to_sint64 0uL) 5ul in 
  let ftmp3 = create (Hacl.Cast.uint64_to_sint64 0uL) 5ul in 
  let x_out = create (Hacl.Cast.uint64_to_sint64 0uL) 5ul in 
  let y_out = create (Hacl.Cast.uint64_to_sint64 0uL) 5ul in 
  let z_out = create (Hacl.Cast.uint64_to_sint64 0uL) 5ul in 
  let tmp = create (Hacl.Cast.uint64_to_sint64 0uL) 5ul in
  let tmp2 = create (Hacl.Cast.uint64_to_sint64 0uL) 5ul in
  let z1z1 = create (Hacl.Cast.uint64_to_sint64 0uL) 5ul in
  let z2z2 = create (Hacl.Cast.uint64_to_sint64 0uL) 5ul in
  let u1 = create (Hacl.Cast.uint64_to_sint64 0uL) 5ul in
  let u2 = create (Hacl.Cast.uint64_to_sint64 0uL) 5ul in
  let s1 = create (Hacl.Cast.uint64_to_sint64 0uL) 5ul in 
  let s2 = create (Hacl.Cast.uint64_to_sint64 0uL) 5ul in 
  let h = create (Hacl.Cast.uint64_to_sint64 0uL) 5ul in 
  let i = create (Hacl.Cast.uint64_to_sint64 0uL) 5ul in 
  let j = create (Hacl.Cast.uint64_to_sint64 0uL) 5ul in 
  let r = create (Hacl.Cast.uint64_to_sint64 0uL) 5ul in 
  let v = create (Hacl.Cast.uint64_to_sint64 0uL) 5ul in 
